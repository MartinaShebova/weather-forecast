...
import { GET_5_DAYS_WEATHER_FORECAST_URL } from "../../backend-services/endpointsUrls";
...
function UserLocationWeather() {
    ...
    useEffect(() => {
        ...
        //         (position) => {
        //             getRequest(GET_5_DAYS_WEATHER_FORECAST_URL(position.coords.latitude, position.coords.longitude))
        //                 .then((info) => {
        //                     setWeatherInfo(info.data.list)
        //                 })
        //         },
        //         (error) => {
    ...
    return <>
        {/* {weatherInfo &&  */}
        <FiveDaysWeather fiveDaysWeatherData={a.list} showHourlyForecast={true} />
        {/* } */}
    </>
}
